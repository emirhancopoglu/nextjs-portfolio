  ...
  return (
    <>
      <div className="flex flex-wrap justify-start gap-4 max-xl:gap-6 max-sm:justify-center">
        <div
          class={`flex flex-col justify-center items-center hover:scale-90 transition-all duration-500 w-[30%] h-60 shadow-xl rounded-md max-sm:h-44 max-sm:w-[46%] max-sm:p-4 max-lg:w-[48%] max-xl:w-[23%] border ${
            theme === "dark" ? "border-gray-500" : "border-gray-200"
          }`}
        >
          <a href="https://www.niksametal.com" target="_blank">
            <Image
              class="w-full h-full cursor-pointer object-contain pointer-events-none"
              alt="Niksa Metal"
